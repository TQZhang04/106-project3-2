<script>
  ...
  // document.getElementById("clickMe").onclick = update_year;
</script>
...
<main>
  <div class="overlay">
    ...
    <input id="slider" type="range" min="1960" max="2022" bind:value={year} />
    <label for="artist" color="#deadff" >Choose an artist:</label>
    <select id="artist" name="artist" bind:value={artist}>
      ...
      <option value="Wallace Roberts and Todd, LLC"> Wallace Roberts and Todd, LLC </option>
      ...
      <option value="Belle Goldschlager Baranceanu"> Belle Goldschlager Baranceanu </option>
      ...
      <option value="Frederick William Schweigardt"> Frederick William Schweigardt </option>
      ...
      <option value="Jackson Woolley and Ellamarie Woolley"> Jackson Woolley and Ellamarie Woolley </option>
      ...
      <option value="Philip Matzigkeit"> Philip Matzigkeit </option>
      <option value="Philipp Scholz Rittermann"> Philipp Scholz Rittermann </option>
      ...
      <option value="Reinhart Revilla Selvik"> Reinhart Revilla Selvik </option>
      ...
      <option value="Stephanie and Ken Goldman"> Stephanie and Ken Goldman </option>
...
<div class="title">
  <center>
    <h1>Public Art Collections in San Diego: {year} {stuff} </h1>
  </center>
